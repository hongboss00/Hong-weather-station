...
String WundergroundClient::getMeteoconIcon(String iconText) {
	//R W B Y  M S N
  if (iconText == "chanceflurries") return "D";
  if (iconText == "chancerain") return "R";
  if (iconText == "chancesleet") return "W";
  if (iconText == "chancesnow") return "W";
  if (iconText == "chancetstorms") return "R";
  if (iconText == "clear") return "B";
  if (iconText == "cloudy") return "Y";
  if (iconText == "flurries") return "D";
  if (iconText == "fog") return "M";
  if (iconText == "hazy") return "Y";
  if (iconText == "mostlycloudy") return "Y";
  if (iconText == "mostlysunny") return "B";
  if (iconText == "partlycloudy") return "P";
  if (iconText == "partlysunny") return "Y";
  if (iconText == "sleet") return "S";
  if (iconText == "rain") return "R";
  if (iconText == "snow") return "W";
  if (iconText == "sunny") return "B";
  if (iconText == "tstorms") return "R";

  if (iconText == "nt_chanceflurries") return "D";
  if (iconText == "nt_chancerain") return "R";
  if (iconText == "nt_chancesleet") return "W";
  if (iconText == "nt_chancesnow") return "W";
  if (iconText == "nt_chancetstorms") return "R";
  if (iconText == "nt_clear") return "N";
  if (iconText == "nt_cloudy") return "Y";
  if (iconText == "nt_flurries") return "D";
  if (iconText == "nt_fog") return "M";
  if (iconText == "nt_hazy") return "Y";
  if (iconText == "nt_mostlycloudy") return "Y";
  if (iconText == "nt_mostlysunny") return "N";
  if (iconText == "nt_partlycloudy") return "PN";
  if (iconText == "nt_partlysunny") return "Y";
  if (iconText == "nt_sleet") return "S";
  if (iconText == "nt_rain") return "R";
  if (iconText == "nt_snow") return "W";
  if (iconText == "nt_sunny") return "N";
  if (iconText == "nt_tstorms") return "R";
